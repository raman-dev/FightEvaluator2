...
import Table from './matchup-tables/Table.vue';
...
<template>
    ...
    <div class="container-fluid">
        ...
        <Table class="mt-2" table-name="MainCard" :columns=standardColumns :matchups="mainCardMatchups"></Table>
        <Table class="mt-2" table-name="Prelims" :columns=standardColumns :matchups="prelimMatchups"></Table>
    </div>
</template>
