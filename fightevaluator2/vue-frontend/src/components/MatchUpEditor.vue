...
<template>
  ...
  <div class="matchup-editor border rounded-2 bg-dark" data-event-id="118">
    ...
    <form>
      <div class="search-box2">
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <input class="form-control rounded-0" data-fighter-id="-1" type="text" value="" name="fighter-a"
              id="fighter-a-input" placeholder="Enter fighter name...">
      ...
      <div class="search-box2">
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <input class="form-control rounded-0" data-fighter-id="-1" type="text" value="" name="fighter-b"
    ...
    <div class="editor-actions mt-3">
      <button type="button" class="btn btn-secondary mx-2 close-btn" v-on:click="hideMatchUpEditor()">Close</button>
      <button type="button" class="btn btn-primary create-btn current-action submit-btn"
        v-on:click="commitChanges(true)">Create</button>
      <button type="button" class="btn btn-primary save-btn submit-btn" v-on:click="commitChanges(false)">Save</button>
    </div>
  </div>
